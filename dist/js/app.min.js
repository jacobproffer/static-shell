...
"use strict";var body=$("html, body"),hamburger=$(".hamburger"),mainNavigation=$(".main-nav");hamburger.click(function(){mainNavigation.toggleClass("nav-open"),$(this).toggleClass("navOpen"),body.toggleClass("body-modal-open"),body.toggleClass("disable-scrolling")}),document.ontouchmove=function(a){for(var o=!0,n=a.target;null!==n;){if(n.classList&&n.classList.contains("disable-scrolling")){o=!1;break}n=n.parentNode}o||a.preventDefault()};