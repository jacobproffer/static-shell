...
var body=$("html, body"),hamburger=$(".hamburger"),mainNavigation=$(".main-nav"),mainHeader=$(".main-header"),links=$('a[href*="#"]'),headerHeight=mainHeader.outerHeight();hamburger.click(function(){mainNavigation.toggleClass("nav-open"),$(this).toggleClass("navOpen"),mainHeader.toggleClass("open"),body.toggleClass("body-modal-open"),body.toggleClass("disable-scrolling")}),links.click(function(){mainNavigation.removeClass("nav-open"),mainHeader.removeClass("open"),hamburger.removeClass("navOpen"),body.removeClass("body-modal-open"),body.removeClass("disable-scrolling")}),mainHeader.headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}}),document.ontouchmove=function(e){for(var n=!0,a=e.target;null!==a;){if(a.classList&&a.classList.contains("disable-scrolling")){n=!1;break}a=a.parentNode}n||e.preventDefault()};